 ...
 * Use case
 */
public class GraphicsHealth implements GraphicsObject {
    ...
    public GraphicsHealth(GraphicsTank graphicsTank, Tank tank, Texture healthTexture, TileMovement tileMovement) {
